...
<div class="row g-3 mb-4 align-items-center justify-content-between">
    <div class="col-auto">
        <h1 class="app-page-title mb-0">Demandes des Cong&eacute;s</h1>
    </div>
    <div class="col-auto">
                    ...
                    <table class="table app-table-hover mb-0 text-left">
                        <thead>
                            <tr>
                                ...
                                <th class="cell tw-text-center">Email</th>
                                ...
                                <th class="cell">Taux planifi&eacute; </th>
                         ...
                         <tbody>
                            ...
                            <tr>
                                <td class="cell">{{ $CongesDAtt->id_p}}</td>
                                ...
                                <td class="cell text-center">{{ $CongesDAtt->taux_plcg }}</td>
                                ...
                                {{-- <td class="cell">
                                    ...
                                    <a href="#edit{{ $CongesDAtt->id_p }}" data-bs-toggle="modal"  data-bs-target="#edit" class="flex tw-items-center  tw-text-white hover:tw-bg-gray-100 hover:tw-text-green-800 tw-border hover:tw-border-green-700 tw-bg-green-700 tw-bg-white-700 focus:tw-ring-4 focus:tw-outline-none focus:tw-ring-green-300 tw-font-medium tw-rounded-lg tw-text-sm tw-px-3 tw-py-2 tw-text-center dark:tw-border-green-500 dark:tw-text-green-500 dark:hover:tw-text-white dark:hover:tw-bg-green-600 dark:focus:tw-ring-green-900">
                                        ...
                                        Accepter</a>
                                         ...
                                         @include('managerviews.congesviews.Demandecongepersonnel.modaledmdacccg')
                                    ...
                                    @include('managerviews.congesviews.Demandecongepersonnel.modaledmdrefus')
                            ...
                            <tr>
                                <td class="cell text-center" colspan="20">Aucune plage de cong&eacute; enregistr&eacute;e</td>
                    ...
                    <table class="table mb-0 text-left">
                        <thead>
                         ...
                         <tbody>
                            ...
                            @forelse ($DcongesVal as $CongesValid )

                            <tr>
                                <td class="cell">{{ $CongesValid->id_p }}</td>
                                ...
                                <td class="cell">{{ $CongesValid->date_depart }}</td>
                                 ...
                                 <td class="cell text-center">{{ $CongesValid->taux_plcg }}</td>
                    ...
                    <table class="table mb-0 text-left">
                        <thead>
                         ...
                         <tbody>
                            ...
                            @forelse ($DcongeRef as $Dconges )

                            <tr>
                                <td class="cell">{{ $Dconges->id_p }}</td>
                                ...
                                <td class="cell">{{ $Dconges->date_depart }}</td>
                                 ...
                                 <td class="cell text-center">{{ $Dconges->taux_plcg }}</td>




                                @if($Dconges->etatvalidpl == $StatutRefdmdcg )
                                <td class="cell"><span class="badge bg-danger"> R&eacute;fus&eacute; </span></td>
